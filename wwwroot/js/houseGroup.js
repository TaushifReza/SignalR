    ...
    if (hasSubscribed) {
        ...
        switch (houseName) {
            case "slytherin":
                ...
                toastr.info("You have subscribe to slytherin house.");
                break;
            case "gryffindor":
                btn_gryffindor.style.display = "none";
                btn_un_gryffindor.style.display = "";
                toastr.info("You have subscribe to gryffindor house.");
                break;
            case "hufflepuff":
                btn_hufflepuff.style.display = "none";
                btn_un_hufflepuff.style.display = "";
                toastr.info("You have subscribe to hufflepuff house.");
                break;
            case "ravenclaw":
                btn_ravenclaw.style.display = "none";
                btn_un_ravenclaw.style.display = "";
                toastr.info("You have subscribe to ravenclaw house.");
                break;
            default:
                break;
        }
        ...
        switch (houseName) {
            case "slytherin":
                ...
                toastr.info("You have unsubscribe from slytherin house.");
                break;
            case "gryffindor":
                btn_gryffindor.style.display = "";
                btn_un_gryffindor.style.display = "none";
                toastr.info("You have unsubscribe from gryffindor house.");
                break;
            case "hufflepuff":
                btn_hufflepuff.style.display = "";
                btn_un_hufflepuff.style.display = "none";
                toastr.info("You have unsubscribe from hufflepuff house.");
                break;
            case "ravenclaw":
                btn_ravenclaw.style.display = "";
                btn_un_ravenclaw.style.display = "none";
                toastr.info("You have unsubscribe from ravenclaw house.");
                break;
            default:
                break;
        }
